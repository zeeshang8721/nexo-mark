            ...
            <div className="max-w-7xl flex flex-col lg:flex-row justify-between items-center py-4 px-5">
                ...
                <div className="hidden lg:flex flex-col lg:flex-row gap-8 lg:gap-10 text-[16px] font-light">
                    {navItems.map((item, index) => (
                        ...
                        >
                            <div
                                className={`flex items-center gap-1 cursor-pointer ${selectedItem === item.label.toLowerCase() ||
                            ...
                            >
                                ...
                                {item.children && (
                                    <IoIosArrowDown
                                        className={`${hoveredItem === item.label ? "rotate-180" : ""
                ...
                {/* Mobile Navigation */}
                <div
                    className={`lg:hidden fixed top-[90px] left-0 w-full h-screen bg-black/95 backdrop-blur-lg z-40 transform transition-all duration-300 ease-in-out ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full"
                        }`}
                >
                    <div className="container mx-auto px-6 pt-5 h-full overflow-y-auto">
                        <div className="flex flex-col space-y-6 text-xl">
                                            ...
                                            {item.isMegaMenu ? (
                                                ...
                                                item.children.map((child, i) => (
                                                    <Link
                                                        key={i}
                                                        href={child.href}
                                                        className="flex items-center gap-3 p-2 rounded-md hover:bg-gray-900/50"
                                                        onClick={() => setIsMobileMenuOpen(false)}
                                                    >
                                                        {child.icon}
                                                        <div>
                            ...
                            <div className="mt-8">
                                <Link href="/contact" onClick={() => setIsMobileMenuOpen(false)}>
                                    <button className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-lg py-3 px-6 shadow-lg hover:shadow-blue-500/30 transition-all">
                                        Get Started
                                    </button>
                                </Link>
                            </div>
                ...
                <div className="hidden lg:block">
                    <Link href="/contact">
                        <button className="bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 py-3 px-6 shadow-lg hover:shadow-blue-500/30">
                            Get Started
                        </button>
                    </Link>
                </div>
