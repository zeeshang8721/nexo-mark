...
const VideoEditingHero = () => {
  return (
    <section className="relative overflow-hidden bg-[#0c0c0c] text-white pt-40 sm:pt-48 pb-26 px-6">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center relative z-10">
        ...
        >
          Sharp cuts, smooth transitions, dynamic visuals we bring your raw
          footage to life with pro-level editing and visual storytelling.
        </motion.p>
        ...
        >
          <div className="absolute top-16 left-10 text-pink-500 animate-pulse">
            <Clapperboard size={48} />
          </div>
          <div className="absolute bottom-20 right-14 text-blue-500 animate-pulse">
            <Camera size={50} />
          </div>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-purple-500 opacity-10">
            <Scissors size={100} />
          </div>
        </motion.div>
      </div>
