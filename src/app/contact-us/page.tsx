...
export default function ContactUs() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!formData.name || !formData.email || !formData.message) {
      setError({ show: true, message: "Please fill all required fields" });
    ...
    try {
      ...
      const payload = {
        ...formData,
        service: serviceMap[formData.service as keyof typeof serviceMap] || formData.service,
        budget: formData.budget ? budgetMap[formData.budget as keyof typeof budgetMap] : undefined,
