...
export const metadata: Metadata = {
  title: "Terms & Conditions | Nexo Mark",
  description:
    "The official Terms & Conditions governing the use of Nexo Mark's digital services, including web development, UI/UX design, marketing, and agency partnerships. This agreement outlines client rights, payment terms, intellectual property, liability, and dispute resolution.",
  alternates: {
    canonical: "https://nexomark.agency/policies/terms-&-conditions",
  },
};
